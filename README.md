...
````
**Notes** 
* `rapidapiKey` is required. You should first create an account on https://rapidapi.com/ and then go to https://rapidapi.com/astsiatsko/api/coronavirus-monitor and use `cases_by_country` endpoint
